...
public class PersonalInfo extends AppCompatActivity {
    ...
    private void saveInfo(){
        final String vol_realName = realName.getText().toString();
        final Integer vol_age = Integer.parseInt(age.getText().toString());
        ...
        final String vol_address = address.getText().toString();
        ...
        updateInfo.setOnClickListener(new View.OnClickListener() {
            ...
            String gender=String.valueOf(Global_Data.vol_gender);
            @Override
            public void onClick(View view) {
                ...
                map.put(new String("gender"), String.valueOf(gender));
